...
#include "init.txt"
  ...
  T_KINEvars_det->SetBranchStatus("kine_pio_angle",1);
    ...
    DLEE_SET_BRANCH_STATUS(v1, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v2, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v3, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v4, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v5, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v6, T_KINEvars_det, 1);
    DLEE_SET_BRANCH_STATUS(v7, T_KINEvars_det, 1);
